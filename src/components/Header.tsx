    ...
    <header className="sticky top-0 z-50">
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative z-10 px-3 sm:px-6">
          <div className="container max-w-7xl mx-auto py-3 sm:py-4 lg:py-5">
            <div className="flex items-center justify-between gap-2 sm:gap-4">
              ...
              <div className="flex items-center gap-2.5 sm:gap-4 min-w-0 flex-1">
                ...
                <div className="relative flex-shrink-0 group">
                  ...
                  <div className="relative w-10 h-10 sm:w-12 sm:h-12 lg:w-14 lg:h-14 rounded-xl sm:rounded-2xl overflow-hidden shadow-2xl transition-transform duration-300 group-hover:scale-105">
                    <img 
                      src={logoImage} 
                ...
                <div className="min-w-0">
                  <div className="flex items-center gap-1.5 sm:gap-2">
                    <h1 className="text-base sm:text-xl lg:text-2xl font-extrabold tracking-tight font-display truncate text-white drop-shadow-md">
                      Success Desirous
                    </h1>
